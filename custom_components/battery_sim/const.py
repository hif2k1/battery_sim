...
BATTERY_OPTIONS = {
    ...
    "Sessy": {
        CONF_BATTERY_SIZE: 5.0,
        CONF_BATTERY_DISCHARGE_EFFICIENCY: 0.81,
    ...
    "Huawei Luna2000 10kW": {
        ...
        CONF_BATTERY_DISCHARGE_EFFICIENCY: 0.99,
    ...
    "BYD Battery Box HVS 5.1kWh": {
        CONF_BATTERY_SIZE: 5.1,
        CONF_BATTERY_DISCHARGE_EFFICIENCY: 0.96,
...
# Ensure predefined batteries use the same default for charge/discharge efficiency.
for battery_option in BATTERY_OPTIONS.values():
    if CONF_BATTERY_DISCHARGE_EFFICIENCY in battery_option:
        battery_option.setdefault(
            CONF_BATTERY_CHARGE_EFFICIENCY,
            battery_option[CONF_BATTERY_DISCHARGE_EFFICIENCY],
        )
